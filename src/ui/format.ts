...
/**
 * A call's length as a clock reads it: 0:07, 4:12, 1:02:09. Western digits in
 * both locales, like every other readout here, and wrapped by the caller in an
 * isolate so the colons do not reorder inside Persian text.
 */
