...
export const Icon = ({ size = 20, children, className, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** A call that went out: away, along the reading direction. */
...
/** A call that came in: back towards the reader. */
