...
import { browserWarmupEnvironment, warmLazyChunks } from './app/warmup'
...
// After the first render, never before it: see `src/app/warmup.ts`.
void warmLazyChunks(
  Object.values(LAZY_CHUNKS),
  browserWarmupEnvironment({ serviceWorker: import.meta.env.PROD }),
)
