...
const RULES = [
  ...
  ['text-muted', 'bubble-in', 4.5, 'when and how a call went, in an incoming bubble'],
  ['danger', 'bubble-in', 4.5, 'a missed call, named in an incoming bubble'],
  ['success', 'bubble-in', 3, 'the arrow of a call that connected, in an incoming bubble'],
